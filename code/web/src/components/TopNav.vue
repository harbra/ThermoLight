<!--
This vue.js file contains the header navigation for the ThermoLight project.
  ...
  <nav class="navbar">
    ...
    <div class="navbar-menu" v-bind:class="{'is-active': burgerOpen}">
      <div class="navbar-end">
        ...
        <div class="navbar-item" v-if="menutitle!=null" v-bind:class="{'is-active': menuOpen, 'has-dropdown': submenus!==undefined, 'is-hoverable': submenus!==undefined}">
          <a v-bind:class="{'navbar-link': submenus!==undefined}" v-on:click="menuOpen=!menuOpen">
            <router-link :to="menulink" tag="div">
              <span class="icon" v-if="menutitleicon!==undefined"><i :class="['icon-' + menutitleicon]"></i></span><span>{{menutitle}}</span>
            </router-link>
          </a>
          <div class="navbar-dropdown" v-if="submenus!==undefined">
...
export default {
  ...
  props: {
    ...
    menulink: {
      type: String,
      default: "/" },
    submenus: Array, // format: linkto, linktext
    settingstitle: {
      type: String,
      default: "Settings" },
    settingslink: {
    ...
    subsettings: {
      type: Array,
      default: () => {
        return [{linkto:'/settings/network', linktext:'Network'},
  ...
  created: function() {
    ...
    // Wifi status does not need to be requested actively as it is provided periodically via WebEvents
