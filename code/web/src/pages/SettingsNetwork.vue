...
<div id="app" class="is-marginless">
  <TopNav title="Settings - Network" subtitle="Network settings of the ThermoLight can be configured here" menutitle="Overview" menutitleicon="thermometer"
    ...
    <div class="container">
      <div class="field is-horizontal">
        ...
        <div class="field-body">
          <div class="field">
            <p class="control">
              <input class="input" type="text" placeholder="ThermoLight name" v-model="SettingsNetwork.ESPName">
            </p>
          </div>
        </div>
      </div>
